...
<body>
                    ...
                    <div class="order-card">
                        ...
                        <div class="order-details">
                            ...
                            <div class="order-actions">
                                ...
                                <a href="{{ route('reviews.index', ['type' => $order['item_type'], 'id' => $order['item_id']]) }}" class="btn-review" style="background: var(--rose-pale); color: var(--rose-main); padding: 10px 20px; border-radius: 25px; text-decoration: none; font-size: 0.8rem; font-weight: 500; border: 1px solid var(--rose-light);">Beri Ulasan</a>
    ...
    <script>
        ...
        // Toggle Right Sidebar (Akun & Jelajahi)
